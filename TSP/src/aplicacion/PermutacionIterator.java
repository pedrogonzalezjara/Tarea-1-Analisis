 ...
 * @author Neko
 */
public class  PermutacionIterator<E> implements java.util.Iterator<List<E>>{
    ...
    public PermutacionIterator(List<E> inList){
                this(inList, inList.size());
        }
   

    public PermutacionIterator(List<E> inList, int m){
        this.inList = inList;
        this.n = inList.size();
        this.m = m;
